...
{/* TODO: To use Keywords that are not part of BuiltIn, which is always imported invisibly, you must import keywords into the current scope. Basically Two different sources of :term[keywords]{term="Keyword"}.
- Libraries, which contains low-level keywords actually implementing functionality, typically in Python.
- Resource Files, which either again import libraries or other :term[Resource Files]{term="Resource File"} or they specify :term[User Keywords]{term="User Keyword"}.  */}
...
[3.1 Resource File Structure](chapter-03/01_resource_file.md)
