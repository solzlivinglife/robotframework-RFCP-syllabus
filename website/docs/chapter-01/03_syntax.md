...
- **Mostly case-insensitive**: Most elements like keyword or :term[variable]{term="Variable"} names are case insensitive.
...
Tests or :term[Tasks]{term="Task"} have a body made up of **keyword calls** and Robot Framework statements like **IF** or **VAR**, which represent the actions or steps executed during the test or task execution.
...
- **Resource Files**: Contain **User Keywords** and are also used to organize the importing of libraries and the definition of variables. These are considered to be part of the test|task data in the *:term[Definition Layer]{term="Definition Layer"}*.
