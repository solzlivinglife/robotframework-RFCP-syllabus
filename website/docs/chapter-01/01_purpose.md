...
[Robot Framework](../glossary#robot-framework) is a versatile, open-source automation framework that supports both **test automation** and **robotic process automation (RPA)**.
Initially designed for acceptance testing, it has since evolved to cover other types of testing and various automation [tasks](../glossary#task) in both IT and business environments.
...
[Robotic Process Automation](../glossary#robotic-process-automation) (RPA) uses software bots to perform tasks and interactions normally performed by humans, without requiring changes to the underlying applications.
